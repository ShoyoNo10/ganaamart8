...
const questions: Question[] = [
  {
    id: 1,
    question: "Би хэзээ төрсөн бэ?",
    options: [
      { id: "a", text: "4-р сарын 29" },
      { id: "b", text: "8-р сарын 26" },
      { id: "c", text: "4-р сарын 8" },
    ],
    correctOptionId: "a",
  },
  {
    id: 2,
    question: "Миний хамгийн дуртай амттан аль вэ?",
    options: [
      { id: "a", text: "Чипс" },
      { id: "b", text: "Чихэр" },
      { id: "c", text: "Шоколад" },
  ...
  {
    id: 3,
    question: "Миний дуртай өнгө аль вэ?",
    options: [
      { id: "a", text: "Цэнхэр" },
      { id: "b", text: "Нил ягаан" },
      { id: "c", text: "Улаан" },
  ...
  {
    id: 4,
    question: "Би ямар тоглоом тоглох дуртай вэ?",
    options: [
      { id: "a", text: "CS2" },
  ...
  {
    id: 5,
    question: "Намайг аль нь илүү тодорхойлдог вэ?",
    options: [
      { id: "a", text: "Чимээгүй" },
      { id: "b", text: "Хөгжилтэй" },
      { id: "c", text: "Даруухан" },
  ...
  {
    id: 6,
    question: "Надад аль чанар илүү байдаг вэ?",
    options: [
      { id: "a", text: "Тусархаг" },
      { id: "b", text: "Хошин" },
      { id: "c", text: "Бодолтой" },
